...
3. НЕ смешивай русские и английские буквы внутри одного слова (например: "триpling", "holdим"). Пиши термины либо полностью на английском, либо на русском.
4. Придумать описание картинки на английском, которая ИЛЛЮСТРИРУЕТ ЭТУ НОВОСТЬ.
...
- Добавляй смайлики внутри текста там, где это уместно (эмоции, действия, рост/падение), чтобы оживить пост. Этот смайлик используй очень редко и никогда в начале поста 🚫
